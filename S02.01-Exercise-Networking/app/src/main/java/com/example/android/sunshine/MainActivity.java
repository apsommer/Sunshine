...
//        }
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                String weatherSearchResults = NetworkUtils.getResponseFromHttpUrl(weatherRequestUrl);
                String[] parsedJSONWeatherData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, weatherSearchResults);
                return parsedJSONWeatherData;
        ...
        @Override
        protected void onPostExecute(String[] parsedJSONWeatherData) {

            if (parsedJSONWeatherData != null) {

                for (String weatherString : parsedJSONWeatherData) {
