...
//              TODO (14) Check if a day has passed since the last notification
                ...
                long oneDayInMilliseconds = DateUtils.DAY_IN_MILLIS;

                boolean moreThanOneDayHasPassed = timeSinceLastNotification >= oneDayInMilliseconds;

//              TODO (15) If more than a day have passed and notifications are enabled, notify the user
                if (notificationsEnabled && moreThanOneDayHasPassed) {
