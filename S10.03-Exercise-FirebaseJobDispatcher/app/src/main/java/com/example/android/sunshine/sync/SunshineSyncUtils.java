...
//  TODO (10) Add constant values to sync Sunshine every 3 - 4 hours
    private static final int START_TIME = 3*60*60; // 3 hours in [second]
    private static final int END_TIME = 4*60*60; // 4 hours in [second]

//  TODO (11) Add a sync tag to identify our sync job
    private static final String SYNC_JOB_TAG = "weather-sync-job-tag";

//  TODO (12) Create a method to schedule our periodic weather sync
    public static synchronized void schuduleSync(final Context context) {

        Driver driver = new GooglePlayDriver(context);
        FirebaseJobDispatcher dispatcher = new FirebaseJobDispatcher(driver);
        Job syncWeatherData = dispatcher.newJobBuilder()
                ...
                // continue to execute this job infinitely
                .setRecurring(true)
                ...
                .setTrigger(Trigger.executionWindow(START_TIME, END_TIME))
        ...
        dispatcher.schedule(syncWeatherData);
