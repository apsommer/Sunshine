...
//  TODO (6) Declare constant IDs for the ViewType for today and for a future day
    private final static int ITEM_VIEW_TODAY = 42;
    private final static int ITEM_VIEW_FUTURE = 43;
...
//      TODO (8) Set mUseTodayLayout to the value specified in resources. This will be false in landscape mode and true for portrait mode.
...
//      TODO (12) If the view type of the layout is today, use today layout
        if (viewType == ITEM_VIEW_TODAY) layout = R.layout.list_item_forecast_today;

//      TODO (13) If the view type of the layout is future day, use future day layout
        else if (viewType == ITEM_VIEW_FUTURE) layout = R.layout.forecast_list_item;
...
//      TODO (15) If the view type of the layout is today, display a large icon
        if (getItemViewType(position) == ITEM_VIEW_TODAY) {
            weatherImageId = SunshineWeatherUtils
                    .getLargeArtResourceIdForWeatherCondition(weatherId);
        }

//      TODO (16) If the view type of the layout is future day, display a small icon
        else if (getItemViewType(position) == ITEM_VIEW_FUTURE) {
            weatherImageId = SunshineWeatherUtils
...
//      TODO (11) Otherwise, return the ID for future day viewType
        if (mUseTodayLayout && position == 0) return ITEM_VIEW_TODAY;
        else return ITEM_VIEW_FUTURE;
