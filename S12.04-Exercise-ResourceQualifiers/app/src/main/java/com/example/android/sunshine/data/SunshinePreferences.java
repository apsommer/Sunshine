...
public final class SunshinePreferences {
    ...
    public static double[] getLocationCoordinates(Context context) {
        ...
        // the 32.3027 double will only be used if nothing is found in the preferences for the key provided! But there will always be a value found, since every hit to the Udacity URL sets these hidden preference values for lat, long. These values are not shown in the UI overflow menu, but they are there! Wow, that took a while to figure out.

        preferredCoordinates[0] = Double
                 .longBitsToDouble(sp.getLong(PREF_COORD_LAT, Double.doubleToRawLongBits(32.5027)));
        preferredCoordinates[1] = Double
                .longBitsToDouble(sp.getLong(PREF_COORD_LONG, Double.doubleToRawLongBits(-117.00371)));
